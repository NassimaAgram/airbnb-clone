package com.example.airbnbclone.user.application;
...
public class Auth0Service {
    ...
    public void assignRoleById(String accessToken, String email, UUID publicId, String roleIdToAdd) throws Auth0Exception {
